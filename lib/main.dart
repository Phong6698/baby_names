...
class MyHomePage extends StatelessWidget {
  ...
  void submitBabyName(String babyName) {}
              ...
              child: new Row(
                children: <Widget>[
                  new Expanded(
                    child: new TextField(
                      decoration:
                          new InputDecoration(labelText: 'Enter baby name'),
                      onSubmitted: (String babyName) => Firestore.instance
                              .runTransaction((transaction) async {
                            CollectionReference collectionReference =
                                Firestore.instance.collection('baby');
                            await collectionReference
                                .add({"name": babyName, "votes": 0});
                          }),
